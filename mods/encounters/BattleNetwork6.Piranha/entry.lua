...
function encounter_init(encounter)
  if math.random(3) == 1 then
    ...
    encounter:create_spawner("BattleNetwork6.RarePiranha.Enemy", Rank.V1):spawn_at(6, 2)
  else
    ...
    encounter:create_spawner("BattleNetwork6.RarePiranha.Enemy", Rank.V2):spawn_at(6, 2)
  end
end
