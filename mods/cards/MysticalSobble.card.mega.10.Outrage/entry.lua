...
local IDLE_DURATION = 170 -- acts as 170f cooldown, warn animation is 30f
...
local function apply_effect(team)
  Field.find_characters(function(character)
    ...
    local aux_prop = AuxProp.new():increase_card_multiplier(0.5):immediate()
