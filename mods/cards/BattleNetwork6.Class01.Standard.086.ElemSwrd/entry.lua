...
function targeting(user)
    ...
    local enemy_filter = function(character)
        return character:team() ~= user:team() and character:hittable() and (character:current_tile():state() == TileState.Grass or character:current_tile():state() == TileState.Ice or character:current_tile():state() == TileState.Sea or character:current_tile():state() == TileState.Volcano or character:current_tile():state() == TileState.Lava)
    end
