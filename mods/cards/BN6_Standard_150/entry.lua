...
local MUSIC_SFX = bn_assets.load_audio("discord.ogg")
local MUSIC_INTERVAL = 64
local IDLE_DURATION = 30 -- acts as 60f cooldown, warn animation is 30f
local PLAY_DURATION = 110
local EFFECT = Hit.Confuse
