...
function card_init(user, props)
	...
	local find_spells = function()
		return Field.find_spells(
			function(entity)
				...
				print(entity:name(), spell_props.element, spell_props.secondary_element, spell_props.damage)
				...
				if element == Element.Fire or
					secondary_element == Element.Fire then
					return true;
				end
				return false
			end
	...
	local activate =
		function(found_entity, element, secondary_element)
			...
			wrapped_action_props.short_name = "AntiFire"
