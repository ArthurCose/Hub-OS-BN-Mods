...
local buster_texture = Resources.load_texture("LineBusterFire.png")
local buster_anim_path = "LineBuster.animation"

local spell_texture = bn_assets.load_texture("fire_tower.png")
local spell_anim_path = bn_assets.fetch_animation_path("fire_tower.animation")

local audio = bn_assets.load_audio("dragon4.ogg")
