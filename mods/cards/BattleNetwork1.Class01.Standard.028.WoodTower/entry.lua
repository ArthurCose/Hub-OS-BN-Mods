...
local buster_texture = Resources.load_texture("LineBusterWood.png")
local buster_anim_path = "LineBuster.animation"

local spell_texture = Resources.load_texture("wood_tower.png")
local spell_anim_path = (_folder_path .. "wood_tower.animation")

local audio = Resources.load_audio("wood_tower.ogg")
